$(document).ready(() => {
    ...
    const getArtist = () => {
        ...
        const $contain2 = $('<div>').addClass('container container-fluid d-flex flex-column flex-wrap justify-content-center');
        const $trackDiv = $('<div>').addClass('container-s col-6  ');
        const $olTrack = $('<ol>');
