$(document).ready(() => {
    ...
    const $contain1 = $('<div>').addClass('container container-fluid d-flex flex-row pl-5'); // cut/paste out classes and/or ids you don't want to use and put them in comments off to the side
